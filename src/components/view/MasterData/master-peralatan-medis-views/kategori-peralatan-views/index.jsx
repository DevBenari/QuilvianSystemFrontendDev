        ...
        <FormProvider {...methods}>
            <Col lg="12" className="iq-card p-4">
                <div className="d-flex justify-content-between iq-card-header">
                    <h2 className="mb-3">Master Data <br></br> <span className='letter-spacing fw-bold'>List Daftar Kategori Peralatan Medis</span></h2>
                        ...
                        <div className="iq-card p-3">
                            <div className="iq-card-header d-flex justify-content-between">
                                <div className="iq-header-title">
                                    <h4 className="card-title font-widest">Tabel Daftar Kategori Peralatan Medis</h4>
                                </div>
                                <ButtonNav
                                    path="/MasterData/master-peralatan-medis/add-kategori-peralatan-medis"
                                    label="Add Pegawai"
                                    icon="ri-add-fill"
                                    size="sm"
                                    variant=""
...
TableListKategoriPeralatanMedis.displayName = 'TableListKategoriPeralatanMedis'
export default TableListKategoriPeralatanMedis;