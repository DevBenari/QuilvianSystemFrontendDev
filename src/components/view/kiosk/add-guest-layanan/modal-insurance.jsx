      ...
      const fetchInsuranceProviders = async () => {
        try {
          ...
          const result = await dispatch(
            fetchAsuransi({ page: 1, perPage: 100 })
          );
                ...
                <>
                  ...
                  {insuranceData.namaAsuransi && (
                    <div className="alert alert-warning mt-2">
                      <small>
                        Asuransi ini tidak bekerja sama dengan rumah sakit
                        (Non-PKS). Pembayaran akan diatur sebagai Tunai, tetapi
                        Anda dapat mengajukan reimbursement ke pihak asuransi.
                      </small>
                    </div>
                  )}
                  <div className="mt-2">
