...
const TopNav = ({ module }) => {
  ...
  return (
    <div className={`iq-topNav fixed-header mb-5`}>
      <div className="iq-navbar-custom px-4">
        <Navbar
          expand="lg"
          className="nav-item d-flex align-items-center border-1 border-color"
        >
          <Navbar.Toggle
            aria-controls="topnav-navbar"
            className="search-toggle iq-waves-effect ml-2"
          />
