...
import TindakanTableLaboratorium from "./tindakanLaboratorium";
const AddPasienLaboratorium = memo(() => {
    ...
    return (
        <div>
            <DynamicForm
                ...
                url="/pendaftaran/pasien-luar-laboratorium"
            />
        </div>
    )
})

AddPasienLaboratorium.displayName = "AddPasienLaboratorium"
export default AddPasienLaboratorium
