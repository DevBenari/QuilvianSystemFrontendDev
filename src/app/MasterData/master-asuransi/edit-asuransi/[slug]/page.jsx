...
import { AsuransiById } from "@/lib/hooks/masterData/master-asuransi";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch data by ID
        const user = await AsuransiById(id);
      ...
      fields: [
        {
          ...
          options: [
            ...
            {
              label: "Perusahaan Kartu Kredit",
              value: "perusahaan kartu kredit",
            },
