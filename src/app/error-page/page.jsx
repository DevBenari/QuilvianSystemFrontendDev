            ...
            <Card.Body className="p-4">
              <div className="mb-4">
                ...
                <p className="text-muted">
                  Sepertinya robot kami kebingungan mencari halaman yang Anda minta. 
                  Mari kita coba kembali ke jalan yang benar!
                </p>
              </div>

              <div className="d-flex flex-column flex-sm-row gap-2 justify-content-center mb-4">
                <Button variant="light" onClick={() => window.history.back()} className="px-4">
                  ← Kembali
                </Button>
