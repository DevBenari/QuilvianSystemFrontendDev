    ...
    const KioskPendaftaranPasien = memo(() => {
        ...
        [
            {
                ...
                [
                    ...
                    },
                    {
                        ...
                        id: "foto",
                        name: "Foto",
                        label: "Scan Foto Identitas Pasien (KTP/Passport)",
        ...
        const handleSubmit = (data) => {
            ...
            // Di handleSubmit, gunakan nama field yang sama persis dengan yang didefinisikan di form
            ...
            // Untuk foto, gunakan nama yang sama
