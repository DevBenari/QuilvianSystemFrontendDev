...
export const titleById = async (id) => {
  try {
    console.log("Fetching title by ID:", id);
    ...
    console.error("Error fetching title (details):", error.response || error);
...
export const editTitle = async (data, id) => {
  ...
  console.log("Updating title with data:", data, "and ID:", id);
  ...
  try {
    ...
    console.error("Error updating title:", error.response || error);
